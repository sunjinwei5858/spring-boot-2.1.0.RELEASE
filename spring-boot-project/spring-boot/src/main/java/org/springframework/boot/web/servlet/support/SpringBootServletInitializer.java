...
/**
 * 实现了WebApplicationInitializer接口，启动靠SpringServletContainerInitializer，
 * SpringServletContainerInitializer靠的是Servlet容器，需要外部tomcat。
 * 换句话说，如果使用springboot内嵌的tomcat 那么不需要理会该类
 * <p>
